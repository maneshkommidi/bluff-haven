      ...
      <section className="relative min-h-screen flex items-center" style={{ background: '#1a2e1a' }}>
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 py-32 w-full">
          <div className="max-w-3xl">
            {/* Eyebrow */}
            <div className="flex items-center gap-4 mb-6 fade-up-1">
            ...
            <div className="flex items-center gap-3 mb-8 fade-up-1">
              <div className="flex items-center gap-1">
                {[1,2,3,4,5].map(s => (
                  <svg key={s} className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20" style={{ color: '#c9a84c' }}>
                    <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/>
                  </svg>
                ))}
              </div>
              <span className="text-sm font-semibold" style={{ color: '#fff' }}>5.0</span>
              <span className="text-sm font-light" style={{ color: 'rgba(255,255,255,0.5)' }}>·</span>
              <Link href="/reviews" className="text-sm font-light hover:underline underline-offset-2 transition-all"
                style={{ color: 'rgba(255,255,255,0.65)' }}>
                {reviews.length} verified guest reviews
              </Link>
              <span className="text-xs font-light px-2 py-0.5 rounded-sm" style={{ background: 'rgba(201,168,76,0.15)', color: '#c9a84c', border: '1px solid rgba(201,168,76,0.25)' }}>
                Airbnb · VRBO
              </span>
            </div>
